...
class Text extends Visual
{
	...
	this.family = ParabolaMain.ftName;
	this.bold = false;
	this.italic = false;
...
class Parabola extends Visual
{
    ...
    Parabola(String id, int a, int b, int c,
    ...
    public Element makeElement()
    {
	Element p = new Element("parabola");
	p.setAttribute( "id", id );
	if (hidden) p.setAttribute( "hidden", "true" );
	...
	color.setAttribute("name","black");
	style.addContent( color );
	Element font = new Element("font");
	font.setAttribute("size","10");
	font.setAttribute("family",ParabolaMain.ftName);
	p.addContent(style);
...
class Polyline extends Visual
{
    ...
    boolean closed;
    String fillColorRed;
    String fillColorGreen;
    String fillColorBlue;
    ...
    {
	this(id,x,y,color, hidden);
	closed = true;
	fillColorRed = red;
	fillColorGreen = green;
	fillColorBlue = blue;
    }
	...
	if (closed)
	{
	    Element fc = new Element( "fill-color" );
	    fc.setAttribute("red",fillColorRed);
	    fc.setAttribute("green",fillColorGreen);
	    fc.setAttribute("blue",fillColorBlue);
	    style.addContent( fc );
	}
	line.addContent(style);
