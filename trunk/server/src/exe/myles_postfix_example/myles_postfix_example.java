...
// file: myles_postfix_example.java
// author: Andrew Jungwirth
// date: 5 June 2006

// This is the front-end program for the PostFixEval.java program in this
...
public class myles_postfix_example{
	...
	params[0] = args[0] + ".sho";
	params[1] = 
	    (String)hash.get("Enter the postfix expression to be evaluated:");

	PostFixEval.main(params);
    }
}
