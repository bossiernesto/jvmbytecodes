...
// Author: Jospeh Naps
// Date: 06-12-2006
// Use: Generates command line input for QueueTest.java
...
public class queuetest
{
	...
	if("Random".equals((String)hash.get("Original Data")))
	{
	    ...
	    for(int i = 1; i < params.length; i++) params[i] = "enq" + (int)(Math.random()*10);
	}
	// Parse given input into proper format
	else
	{
	    String input = (String)hash.get("Enter sequence of operations here(\"deq\" to dequeue or \"enqx\" to enqueue \"x\")");
	...
	params[0] = args[0] + ".sho";
	JoeQueueTest.main(params);	// call the main method of the generation program
    }
}
