...
#   system("java exe/parampassing3/RandomProblemGenerator " . $target . ".sho1 " . $target . ".sho2 " . $target . ".html 1 1");

# Something goes wrong here when I create the php reference instead of the html
    ...
    system("cp " . $target . ".sho2 " . $target . ".sho");
