...
public class LinearHashing{
    ...
    public LinearHashing(String GaigsFile, String tableSizeStr, String numKeysStr){
    ...
    private void InsertKeys(){
        ...
        for(int x = 0; x < numKeys; x++){
            ...
            while(!(((arraySlot)Table.elementAt(hashCode)).contents).equals(".")){
                ...
                createSnapShot(-1, captionVect, true);
                captionVect.removeAllElements(); 
                captionVect.addElement("Increment the hash code and try again.");
                captionVect.addElement("Hash code = "+hashCode+" + 1 = "+(hashCode+1)+".");
                if(hashCode < tableSize -1)
                    hashCode++;
                else{
                    hashCode = 0;
                    captionVect.addElement("Since "+(hashCode+1)+" is equal to the table size, reset the hash code to zero.");
                }
                captionVect.addElement("Insert key "+currentKey+" into slot "+hashCode+".");
            }
    ...
    public static void main(String args[]){
        new LinearHashing(args[0], args[1], args[2]);
        System.exit(0);
    }
    class arraySlot{
