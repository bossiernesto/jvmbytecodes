...
// Author: Joseph Naps
// Date: 06-12-2006
// Use: Generates command line input for LinkedListTest.java
...
public class linkedlisttest
{
	...
	// User has chosen to randomly generate input
	...
	params[0] = args[0] + ".sho";
	JoeLinkedListTest.main(params); // Call the main method of the generation program
    }
}
